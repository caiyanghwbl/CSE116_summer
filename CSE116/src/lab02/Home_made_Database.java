...
//				assert Description.length() == RECORD_LENGTH;
				...
				while(true) {
					skill_level_input = JOptionPane.showInputDialog(null, "Please enter skill level(1-99): ");
					try {
				...
				if(skill_level < 1 || skill_level > 99) {
...
//				String record = String.format("%1$"+5+"s", idnum, player_name, team_name, skill_level, date);
